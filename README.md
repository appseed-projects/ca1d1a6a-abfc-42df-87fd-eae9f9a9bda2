...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-01 15:30`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ca1d1a6a-abfc-42df-87fd-eae9f9a9bda2.git
$ cd ca1d1a6a-abfc-42df-87fd-eae9f9a9bda2
```
